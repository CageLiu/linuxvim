...
if g:lucius_style == "dark"
    ...
    hi Normal       guifg=#d7d7d7   guibg=#080808   ctermfg=188    ctermbg=236       gui=none      cterm=none
    ...
    hi CursorColumn guifg=NONE      guibg=#151515   ctermfg=NONE   ctermbg=238       gui=none      cterm=none
    hi CursorLine   guifg=NONE      guibg=#151515   ctermfg=NONE   ctermbg=238       gui=none      cterm=none
    ...
    hi LineNr       guifg=#626262   guibg=#151515   ctermfg=241    ctermbg=238       gui=none      cterm=none
    hi CursorLineNr guifg=#626262   guibg=#151515   ctermfg=241    ctermbg=238       gui=none      cterm=none
